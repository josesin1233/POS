...
urlpatterns = [
    ...
    path('api/suscripcion/registrar/', subscription_views.register_subscription, name='register_subscription'),
    ...
    path('suscripcion/confirmada/', views.confirmar_suscripcion, name='confirmar_suscripcion'),
]